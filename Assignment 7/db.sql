...
CREATE USER 'webshop'@'127.0.0.1' IDENTIFIED BY '1234';
GRANT USAGE ON *.* TO 'webshop'@'127.0.0.1' REQUIRE NONE WITH MAX_QUERIES_PER_HOUR 0 MAX_CONNECTIONS_PER_HOUR 0 MAX_UPDATES_PER_HOUR 0 MAX_USER_CONNECTIONS 0;
