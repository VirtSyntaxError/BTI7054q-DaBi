...
INSERT INTO i18n(text_en, text_de) VALUES
	...
	('Fossil's Q Venture offers essential health and fitness features without sacrificing style.', 'Venture - eine stylishe Uhr mit smarten Funktionen. Zusätzlich zum neuen Display mit Vollbildanzeige hat unsere Venture zahlreiche Features wie individuell einstellbare Zifferblätter, diskrete Benachrichtigungen und automatisches Aktivitätstracking.'),
	('Meet Grant, our classic hybrid that looks like a watch, but acts like a smartwatch.','Die Fossil Q Grant eine Hybrid Smartwatch, bei der auf das Design von analogen Uhren nicht verzichtet werden muss. Fossil hat hier ein sehr modisches Wearable mit modernster Konnektivität hervorgebracht. Sie zählt Schritte, errechnet den Kalorienverbrauch und empfängt und filtert Mitteilungen.'),
	('The Tissot PRC 200 is a popular range of the T-Sport watch collection that is built for performance and features Swiss quality and craftsmanship at an affordable price. This flagship collection of timepieces is available in a multitude of looks to compliment individual wants that can be worn formally to work or casually in your leisure time.','Diese Kollektion bietet für jeden Geschmack das Richtige, von der sportlichen Ausführung bis hin zum wahren Klassiker – in der Tissot PRC 200 Familie findet sich die passende Uhr. Der große Erfolg der Tissot PRS 200 Sportlinie bewog Tissot dazu, eine weitere Sportuhr zu präsentieren, die ebenfalls bis zu einem Druck von 20 bar (200 m) wasserdicht ist und gleichzeitig durch eine etwas klassischere Optik besticht: die Tissot PRC 200. Dank der abgesetzten Lünette wirkt das Zifferblatt sehr groß, und in Verbindung mit den mit Superluminova beschichteten Indexen und Zeigern lässt sich die Zeit noch besser ablesen.'),
	('','Zuverlässigkeit, Präzision und Innovation: Schlüsselwerte, die Certina hier erneut beweist. Und auch der kühne Kurs des Hauses findet seine Fortsetzung in der neuen DS Action, eine Uhr für allerhöchste sportliche Herausforderungen. Die neuen Certina DS Action Modelle für Damen vereinen Dynamik, Zuverlässigkeit und Ausdauer am Handgelenk aller Sportbegeisterten. Ein weiteres Highlight dieser DS Action ist das höchst präzise, von der COSC als Chronometer zertifizierte, ETA-PRECIDRIVE-Quartzwerk. Die sagenhafte Wasserdichtigkeit von 30 ATM (300m), lässt die Herzen von Taucherinnen um einiges höher schlagen. Das ist echte Swiss Made Qualität welche für maximale Anforderungen an Robustheit und hervorragende Ablesbarkeit steht. Eine Uhr die hält was sie verspricht!'),
	('',''),
	('',''),
	('',''),
	('',''),
